...
# 用于ResNet18和34的残差块，用的是2个3x3的卷积块，也就是BasicBlock
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, in_channel=3, num_classes=2):
...
if __name__ == '__main__':
    ...
    net = ResNet50().cuda()
    y = net(x)
    torch.onnx.export(net, x, "resnet_50.onnx", verbose=True, opset_version=12)
